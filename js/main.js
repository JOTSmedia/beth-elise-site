  ...
  function escapeHtml(str) {
    ...
    if (heroBgCanvas && heroAvatarCanvas) {
      ...
      function updateBethSpeechBubblePosition() {
        ...
        const targetX = (isDualState && heroTinkerbell.fairyX !== undefined) ? heroTinkerbell.fairyX : heroTinkerbell.x;
        const targetY = (isDualState && heroTinkerbell.fairyY !== undefined) ? heroTinkerbell.fairyY : heroTinkerbell.y;
